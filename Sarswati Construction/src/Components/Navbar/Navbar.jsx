    ...
    <>
      ...
      <div className='Navbar bg-[#0606066b] flex items-center justify-around p-4'>
        ...
        >
          ...
          <li className="naviconsele hover:text-[#B96D79] "><AnchorLink href='#Home' className='anchorlink'>Home</AnchorLink></li>
          <li className="naviconsele hover:text-[#B96D79]"><AnchorLink href='#AboutUs' className='anchorlink'>About Us</AnchorLink></li>
          <li className="naviconsele flex items-center gap-2 hover:text-[#B96D79]">
            <AnchorLink href='#RoseAvenue' className='anchorlink'>Our Services</AnchorLink>

          </li>
          <li className="naviconsele hover:text-[#B96D79] "><AnchorLink href='#Amenities' className='anchorlink'>Amenities</AnchorLink></li>
          <li className="naviconsele hover:text-[#B96D79]"><AnchorLink href='#Contact' className='anchorlink'>Contact</AnchorLink></li>
          <button onClick={handleOpen} className='quotes hidden bg-[#B96D79] p-3 px-8 rounded-3xl max-lg:p-2 max-lg:text-base  max-lg:px-5 max-md:block max-md:text-2xl max-md:px-6'>Get a Quote</button>

        </div>
        <div className='getquotes flex items-center justify-center gap-2 font-bold max-md:hidden md:flex'>

          <button onClick={handleOpen} className='quotes bg-[#B96D79] p-3 px-8 rounded-3xl max-lg:p-2 max-lg:text-base  max-lg:px-5 max-md:text-[10px] max-md:px-4'>Get a Quote</button>
