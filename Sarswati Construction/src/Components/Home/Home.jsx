      ...
      <div className=' relative animate-fadeIn' id='Home' >
        ...
        <div className=' absolute top-0 w-full my-4'>
         ...
         <div className='homecontent-center absolute top-80 left-28 flex gap-7 flex-col '>
           <h1 className='homecontent-center-line font-bold text-8xl text-white' data-aos="slide-right">SARASWATI</h1>
           <h3  className='homecontent-center-line font-bold text-4xl text-white' data-aos="slide-right" >Consultancy & Constructions</h3>
           <p className='homecontent-center-line text-4xl text-white' data-aos="slide-right">Building a Better Tomorrow</p>
