    ...
    return (
        <div className='contact-maindiv w-full bg-[#F5F5F5] flex justify-between max-md:flex-col max-md:gap-7 ' id='Contact'>
            <div className='contact-left  w-[33%] flex flex-col gap-[15px] justify-center pl-16 max-lg:gap-3  max-lg:w-fit max-md:w-full  max-md:pl-0 '>
                <div className='contact-heading w-[374px] h-[103px] flex flex-col gap-5 max-lg:gap-2 max-lg:-mb-5  max-md:m-auto max-md:text-center ' >
                ...
                <div className='contact-left-details font-medium text-[16px] w-[426px] max-xl:w-[350px] max-lg:text-[12px]   max-md:m-auto max-md:text-center '>
                    <ol >
                ...
                <div className='contact-address w-[426px] h-[166.97px] bg-white rounded-3xl  flex flex-col justify-center shadow-lg max-xl:w-[350px] max-xl:px-5 max-xl:h-32  max-xl:pt-3 max-lg:h-fit max-lg:pb-3  max-md:m-auto '>
                    <div className='w-[356px] h-[128.97px] m-auto flex flex-col gap-1 max-2xl:w-fit max-lg:h-fit'>
                ...
                <AnimateUpDown direction='up'>
                <div className='contact-phone w-[426px] h-[140.97px] bg-white rounded-3xl  flex flex-col justify-center shadow-lg max-xl:w-[350px] max-xl:px-5 max-xl:h-32  max-xl:pt-3 max-lg:h-fit max-lg:pb-3  max-md:m-auto ' >
                    <div className='w-[356px] h-[102.97px] m-auto flex flex-col gap-1 max-lg:h-fit'>
                    <img src={location_icon} alt="" className='w-[25.48px] h-[33.97px] max-xl:w-[12px] max-xl:h-[18px]' />
                ...
                <AnimateUpDown direction='up'>
                <div className='contact-email w-[426px] h-[140.97px] bg-white rounded-3xl  flex flex-col justify-center shadow-lg max-xl:w-[350px] max-xl:px-5 max-xl:h-32  max-xl:pt-3 max-lg:h-fit max-lg:pb-3  max-md:m-auto '>
            ...
            <div className='contact-imagesection w-[66%] h-[868px] flex justify-end max-xl:h-fit max-md:w-full'>
                ...
                <iframe className='w-[1300px] h-[868px] border-2 max-2xl:w-[850px] max-xl:w-[700px] max-xl:h-[800px] max-lg:h-[600px] max-lg:w-[500px] max-md:w-[100%]  ' src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7326.21519380224!2d85.270039!3d23.3481161!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4df000e8915df%3A0xf9d2aec92255e69d!2sRose%20Avenue%20-%20project%20by%20Sarswati%20Consultancy%20and%20Construction!5e0!3m2!1sen!2sin!4v1721806130810!5m2!1sen!2sin" ></iframe>
                </div>
            </div>
        </div>
    )
